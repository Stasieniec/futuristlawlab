...
export default function MemberList({ team, onMembersUpdated }: MemberListProps) {
  ...
  const isOverDisplayMax = team.members.length > DISPLAY_MAX_MEMBERS;
    ...
    <div>
        ...
        <div className="mb-4 bg-amber-50 border-l-4 border-amber-500 p-4 rounded">
          <div className="flex items-start">
            ...
            <p className="text-amber-800 text-sm font-medium">
              Your team has more than {DISPLAY_MAX_MEMBERS} members. Please confirm with the organizers that this is allowed.
            </p>
          </div>
        </div>
      )}
        ...
        <div>
          {isAdding ? (
            ...
            <button
              ...
              className={`w-full px-4 py-3 border-2 border-dashed font-medium rounded-lg transition-all duration-200 flex items-center justify-center ${
                isAtDisplayMax
      ...
      {team.members.length >= MAX_MEMBERS && (
        <div className="mt-4 bg-amber-50 border-l-4 border-amber-500 p-4 rounded">
          <p className="text-amber-800 text-sm font-medium">
            Team is full ({MAX_MEMBERS} members maximum)
          </p>
        </div>
      )}
