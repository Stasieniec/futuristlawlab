        ...
        <div className="container mx-auto px-4 py-4">
          <nav className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link href="/join-us" className="text-blue-700 font-bold hover:text-blue-800 transition" aria-label="Join our team">Join Us</Link>
            </div>
          ...
          <div className="mobile-menu hidden md:hidden">
            <div className="flex flex-col space-y-4 pt-4 pb-3 px-4">
              ...
              <Link href="/join-us" className="text-blue-700 font-bold hover:text-blue-800 transition py-2" aria-label="Join our team">Join Us</Link>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/join-us" className="text-blue-400 hover:text-blue-300 transition font-medium">Join Us</Link></li>
              </ul>
            </div>
