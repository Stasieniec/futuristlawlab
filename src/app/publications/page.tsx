    ...
    <div className="min-h-screen bg-white">
      ...
      {featuredPublications.length > 0 && (
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4">Featured Publications</h2>
              <p className="text-slate-700">Highlighting noteworthy academic work in legal technology</p>
            </div>
                    ...
                    <div className="lg:w-2/3 p-6 sm:p-8 lg:p-12">
                      ...
                      <div className="flex flex-wrap gap-2 mb-6">
                        ...
                        {publication.tags.length > 3 && (
                          <span className="text-slate-500 text-sm">+{publication.tags.length - 3} more</span>
                        )}
                      </div>
