// Team member data — to add a new member, add an object to this array.
...
export const teamMembers: TeamMemberInfo[] = [
  ...
  {
    name: 'Clara Langenbach',
    role: 'Legal Team',
    photo: '/images/team/clara.jpeg',
